...
class Arguments():
    ...
    def __init__(self):
        ...
        parser.add_argument('-m', '--method', help="Heuristic approach",
                            choices=['swap', '2opt', 'vnd', 'vns', 'grasp', 'all'], default='all', type=str)
        ...
        parser.add_argument('-n', '--number-interations',
                            help='Max VNS interations', default=5, type=int)
        parser.add_argument(
            '-o', '--optimal', help='Optimal result', default=0, type=int)
        parser.add_argument(
